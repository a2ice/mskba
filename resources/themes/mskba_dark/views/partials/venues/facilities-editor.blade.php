...
<section class="venue-facilities-editor" data-venue-facilities-editor>
    ...
    <div class="venue-facilities-editor__grid">
        <fieldset class="venue-facilities-editor__control">
            <legend><i class="ti ti-basketball-hoop" aria-hidden="true"></i> <span title="Количество колец определяет число игровых зон: при двух кольцах можно отдельно бронировать половины A и B.">Количество колец</span></legend>
