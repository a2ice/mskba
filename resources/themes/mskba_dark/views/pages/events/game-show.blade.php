...
@section('content')
    <section class="game-control first-screen" data-game-control data-game-lifecycle-url="{{ route('events.games.lifecycle.show', $gameRouteParameters) }}">
        <div class="inner game-control__inner">
            ...
            <form method="POST" action="{{ route('events.games.statistics', $gameRouteParameters) }}" data-game-live-statistics data-scoring-type="{{ $game->scoring_type->value }}" data-image-upload-surface>
