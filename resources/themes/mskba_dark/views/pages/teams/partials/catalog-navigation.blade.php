...
<nav class="default-category-sidebar__nav" aria-label="Навигация по командам">
    ...
    @auth
        <a href="{{ route('account.teams') }}"><span>Мои команды</span><i class="ti ti-user-shield" aria-hidden="true"></i></a>
    @endauth
    <a href="{{ route('teams.create') }}"><span>Создать команду</span><i class="ti ti-plus" aria-hidden="true"></i></a>
</nav>
