@php
    ...
    $content = match ($status) {
        400 => ['Некорректный запрос', $exceptionMessage ?: 'Проверьте отправленные данные и повторите действие.', 'На главную', url('/')],
        ...
        409 => ['Возник конфликт', $exceptionMessage ?: 'Данные успели измениться. Обновите страницу и повторите действие.', 'Обновить страницу', request()->fullUrl()],
        ...
        422 => ['Не удалось выполнить действие', $exceptionMessage ?: 'Проверьте данные и повторите действие.', 'Вернуться назад', url()->previous()],
