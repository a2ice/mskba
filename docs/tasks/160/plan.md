...
1. [x] Проверить актуальный `main`, историю задач, ownership UI и audit.
2. [x] Зафиксировать data model, permissions, audit и критерии приёмки.
3. [x] Добавить миграцию, модельный инвариант и casts.
