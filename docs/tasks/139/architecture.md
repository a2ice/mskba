...
Статус: **отложено**, 2026-09-09. ADR-139-003 не принят: пользователь решил не
создавать отдельную Vue-тему и не выполнять глобальную миграцию на текущем этапе.
Документ сохранён как историческое исследование. Актуальная стратегия — переносить
правила принятого гайдлайна небольшими блоками в существующую тему `mskba_dark`.
