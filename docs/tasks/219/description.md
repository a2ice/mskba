# 219 — Декомпозировать web routes по bounded contexts и добавить route integrity checks
...
Новые bounded-context routes после Task 219 должны добавляться сразу в
...
Task 219 — refactoring task. В одном переносе не следует одновременно
