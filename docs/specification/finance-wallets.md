...
На этом этапе UI не даёт пополнять, выводить или переводить средства и не
создаёт покупки. Эти действия должны появляться только вместе с соответствующим
Purchase/Payment flow, а не как прямые мутации ledger из Presentation.
