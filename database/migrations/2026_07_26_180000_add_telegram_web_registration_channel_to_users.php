...
return new class extends Migration
{
    ...
    {
        DB::table('users')
            ->where('registration_channel', UserRegistrationChannelEnum::TELEGRAM_WEB->value)
            ->update(['registration_channel' => UserRegistrationChannelEnum::OTHER->value]);

        $values = collect(UserRegistrationChannelEnum::cases())
            ->reject(fn (UserRegistrationChannelEnum $channel): bool => $channel === UserRegistrationChannelEnum::TELEGRAM_WEB)
