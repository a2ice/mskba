...
final readonly class VenueDetailsDTO
{
     ...
     * @param  array<int, array{id: int, name: string, alias: string, routeIdentifier: string, isPrimary: bool, supportsHalves: bool}>  $courts
     * @param  array{id: int, name: string, alias: string, routeIdentifier: string, isPrimary: bool, supportsHalves: bool}  $selectedCourt
