...
final readonly class RequestVenueBookingHandler
{
    ...
    public function handle(Actor $actor, string $quotePublicId): VenueBooking
    {
        ...
        $booking = DB::transaction(function () use ($actor, $user, $quote): VenueBooking {
            ...
            DB::afterCommit(static fn () => event(new VenueBookingRequested($booking->id)));
