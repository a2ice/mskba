...
final class StoreEventResultPhotoRequest extends FormRequest
{
    ...
    {
        return ['photo' => ['required', 'file', 'image', 'mimes:jpg,jpeg,png,webp', 'max:10240', 'dimensions:max_width=6000,max_height=6000']];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'photo.uploaded' => 'Не удалось загрузить изображение. Выберите файл размером не больше 10 МБ.',
            'photo.mimes' => 'Поддерживаются только JPEG, PNG и WebP.',
            'photo.max' => 'Изображение должно быть не больше 10 МБ.',
