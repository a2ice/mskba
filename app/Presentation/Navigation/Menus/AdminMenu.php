    ...
    public function items(): array
    {
        ...
        return [
            ...
            [
                ...
                'description' => 'Заявки, подтверждённые владения, документы и ограничения.',
                'url' => $this->routeUrl('admin.venue-ownership.index'),
                'active' => $this->isActiveRoute('admin.venue-ownership.*'),
                'visible' => $isAdmin,
                'icon' => 'ti-certificate',
                'data' => ['count' => 0],
            ],
